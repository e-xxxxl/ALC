    ...
    return (
      <div className="pt-[140px] pb-24 text-center space-y-6">
        ...
        <div className="pt-2">
          <Link 
            href="/our-services" 
            className="inline-flex items-center gap-1.5 bg-brand-primary text-white text-xs font-bold px-5 py-3 rounded-lg"
          >
      ...
      <section className="bg-slate-50 py-16 md:py-24 border-b border-slate-100 relative">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex items-center gap-1.5 text-xs text-gray-500 mb-6 font-medium">
            ...
            <Link href="/our-services" className="hover:text-brand-primary">Our Services</Link>
            <ChevronRight size={12} className="text-gray-400" />
            <span className="text-brand-primary font-semibold truncate max-w-[200px]">{service.title}</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              {service.badge && (
                <span className="bg-amber-50 border border-amber-200 text-brand-accent font-semibold font-mono text-[10px] px-3.5 py-1.5 rounded-full uppercase">
                  {service.badge}
                </span>
              )}
              ...
              <div className="pt-4 flex flex-wrap gap-3">
                <Link 
                  href="/contact-us" 
                  className="bg-brand-primary text-white hover:bg-brand-primary/95 text-xs font-semibold px-5  py-3 rounded-lg flex items-center gap-1.5 shadow-md"
                >
                  <PhoneCall size={14} /> Book Free Assessment
                </Link>
                <Link 
                  href="/our-services" 
                  className="border border-gray-200 text-gray-800 hover:text-brand-primary text-xs font-semibold px-5 py-3 rounded-lg flex items-center gap-1.5 hover:bg-slate-50"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="space-y-4">
                <h2 className="text-2xl font-heading font-bold text-brand-primary">How We Assist & Support</h2>
              ...
              <div className="space-y-4">
                <h3 className="font-heading font-bold text-brand-primary text-lg">What is included in this Support pathway?</h3>
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="bg-brand-primary text-white p-6 md:p-8 rounded-3xl space-y-6 shadow-md relative overflow-hidden">
                ...
                <ul className="space-y-4 text-xs font-light">
                  {service.whoItsFor.map((audience, idx) => (
                    <li key={idx} className="flex items-start gap-2.5">
                      <span className="w-5 h-5 rounded-full bg-white/10 text-brand-accent text-[10px] font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                        {idx + 1}
                      </span>
                ...
                <div className="pt-2 border-t border-white/10 text-[10.5px] text-sky-200 flex items-center gap-2">
                  <GraduationCap size={15} className="text-brand-accent" /> Custom programs evaluated weekly
                </div>
              </div>
